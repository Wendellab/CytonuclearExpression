...
# from https://biopython.org/wiki/Sequence_Cleaner, accessed July 2022
...
def sequence_cleaner(fasta_file, min_length=0, por_n=100):
    ...
    with open("clean_" + fasta_file, "w+") as output_file:
...
try:
    if len(userParameters) == 1:
        ...
        print("Usage: python sequenceCleaner.py input min_length %N_allowed")
except:
    print("Usage: python sequenceCleaner.py input min_length %N_allowed")
